...
import { ScholarshipMatchPanel, ScholarshipImprovementSection } from "@/components/scholarships/details/ScholarshipMatchPanel";
import Link from "next/link";
import { Metadata } from "next";
import { SaveButton } from "@/components/scholarships/details/SaveButton";
      ...
      <div className="bg-gradient-to-br from-primary/10 via-background to-background rounded-3xl p-8 sm:p-12 border border-primary/10 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <SaveButton scholarshipId={scholarship.id} className="rounded-xl px-8 h-12 text-base font-semibold" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="w-full lg:w-80 flex-none space-y-6">
          <div className="sticky top-24 space-y-6">
            ...
            <div className="bg-background rounded-2xl p-6 border border-border shadow-sm">
              ...
              <div className="mt-8 space-y-3">
                ...
                <div className="flex gap-3">
                  <SaveButton scholarshipId={scholarship.id} size="default" className="flex-1 h-12" />
            ...
            <ScholarshipMatchPanel scholarshipId={scholarship.id} />
