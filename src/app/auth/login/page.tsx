...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    // On success, the server action handles the redirect — no need to do it here
  };

  return (
    <motion.div variants={fadeUp} initial="hidden" animate="visible" className="w-full">
      <h1 className="text-3xl font-heading font-bold mb-2 tracking-tight">Welcome back</h1>
      <p className="text-muted-foreground mb-8">Sign in to continue growing your legacy.</p>
      ...
      <div className="mt-8 grid grid-cols-2 gap-4">
        <Button variant="outline" className="h-12 border-border/50 hover:bg-muted">
