...
const menuItems: { name: string; href: string; icon: IconName }[] = [
  { name: "Profile Setup", href: "/onboarding", icon: "User" },
  { name: "Dashboard", href: "/dashboard", icon: "LayoutDashboard" },
  { name: "Scholarship Explorer", href: "/scholarships", icon: "Search" },
  { name: "Saved Scholarships", href: "/scholarships/saved", icon: "Bookmark" },
...
export function DashboardSidebar() {
  ...
  const fullName = user?.user_metadata 
    ...
    : "";
  const name = fullName || user?.email?.split("@")[0] || "Scholar";
  const email = user?.email || "scholar@example.com";
