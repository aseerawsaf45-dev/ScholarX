  ...
  "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-xl bg-card py-(--card-spacing) text-sm text-card-foreground [--card-spacing:--spacing(4)] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(3)] data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        elevated: "shadow-medium ring-1 ring-border/50",
        interactive: "ring-1 ring-border hover:shadow-medium hover:-translate-y-1 hover:ring-primary/50 cursor-pointer",
        premium: "shadow-premium ring-1 ring-primary/20 bg-gradient-to-br from-background to-muted/50 hover:shadow-premium hover:ring-primary/40",
      },
      size: {
        default: "",
        sm: "",
