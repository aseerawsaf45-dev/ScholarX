...
export function ProfileCompletionWidget() {
  ...
  const isComplete = progress.profileCompletion >= 70;
          ...
          <div className="mt-4 w-full">
            {!isComplete ? (
              <div className="space-y-3">
                ...
                <Button className="w-full text-xs h-8" variant="default" asChild>
                  <Link href="/onboarding">Fix Missing Fields</Link>
                </Button>
              </div>
            ) : (
              <div className="flex flex-col items-center text-green-500">
                <Icon name="CircleCheck" className="mb-1" />
